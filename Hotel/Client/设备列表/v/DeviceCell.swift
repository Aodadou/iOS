...
@objc protocol DeviceCellDelegate:NSObjectProtocol{
...
class DeviceCell: UITableViewCell{
    ...
    func addGesture(){
        ...
        self.panGesture = UIPanGestureRecognizer(target: self, action: #selector(DeviceCell.handlePan(_:)))
    ...
    */
    ...
    @IBAction func tapMainBtnClose(_ sender: AnyObject) {
        ...
        self.delegate?.detailClick(self,position: position)
    }
    
    @IBAction func modifyDeviceName(_ sender: AnyObject) {
        self.delegate?.modifyName(self,position: position)
    }
    
    @IBAction func deleteDevice(_ sender: AnyObject) {
        self.delegate?.deleteDevice(self,position:position)
    }
    
    @IBAction func addToCommondList(_ sender: AnyObject) {
        self.closeSlideView()
        self.delegate?.addToNormal(self, position: self.position)
    }
    ...
    */
    func closeSlideViewByPosition(){
        ...
        if tbv != nil{
            for cell in (tbv?.visibleCells as! [DeviceCell]){
